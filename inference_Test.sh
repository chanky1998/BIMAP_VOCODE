...
#SBATCH --job-name=inference_512ch_test
...
EXP_NAME="512 Channels (g_00000050)"
CONFIG_FILE="cp_hifigan/v1_c512/config.json"
CHECKPOINT_FILE="$HOME/hifi-gan/cp_hifigan/v1_c512/g_00000050"
