...
def train(rank, a, h):
    ...
    if rank == 0:
        ...
        os.makedirs(a.history_checkpoint_path, exist_ok=True)
        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.checkpoint_interval == 0 and steps != 0:
                    filename_g = "g_{:08d}".format(steps)
                    filename_do = "do_{:08d}".format(steps)

                    latest_g_path = os.path.join(a.checkpoint_path, filename_g)
                    latest_do_path = os.path.join(a.checkpoint_path, filename_do)
                    history_g_path = os.path.join(a.history_checkpoint_path, filename_g)
                    history_do_path = os.path.join(a.history_checkpoint_path, filename_do)
                    ...
                    save_checkpoint(latest_g_path, generator_state)
                    save_checkpoint(history_g_path, generator_state)
...
def main():
    ...
    parser.add_argument('--input_training_wavs_dir', default='LibriSpeech_wav/train')
    parser.add_argument('--input_validation_wavs_dir', default='LibriSpeech_wav/dev')
